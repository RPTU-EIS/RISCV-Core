...
class top_MC(BinaryFile: String, DataFile: String) extends Module {
  ...
  //printf(p"------------------------------------ID------------------------------------\n")
  //printf(p"ID instruction: 0x${Hexadecimal(ID.io.instruction.asUInt)}\n")
  ...
  //printf(p"------------------------------------HzdUnit------------------------------------\n")
  //printf(p"HZDUNIT stall: ${HzdUnit.io.stall}, stall_membusy: ${HzdUnit.io.stall_membusy}, flushD: ${HzdUnit.io.flushD}, flushE: ${HzdUnit.io.flushE}, branchTaken: ${HzdUnit.io.branchTaken}, branchToDo: ${HzdUnit.io.branchToDo},\n")
